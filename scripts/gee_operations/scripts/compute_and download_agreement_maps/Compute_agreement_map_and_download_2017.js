...
var from_glc_image = ee.Image(
  'projects/ee-mudeledimeji/assets/postdoc/deforestation_mdg_paper/rasters/from_glc_landcover/FROM_GLC_yearImg_2017'
  ).clip(roi);
...
var palsar_image_trees = palsar_image.eq(1).or( palsar_image.eq(2));
...
var esri_image = ee.Image(
  'projects/ee-mudeledimeji/assets/postdoc/deforestation_mdg_paper/rasters/esri_landcover/esri_mdg_2017'
  ).clip(roi);
...
Export.image.toDrive({
  ...
  description: "agreement_map_2017_30m", // Get the export name as a plain JavaScript string
