//////////////
///Created by Oladimeji Mudele
///////////////


// CHECK AGREEMENT FOR YEAR 2016
// Data used: DW, FROM_GLC, PALSAR, CGLS, MF-GFC
...
var from_glc_image = ee.Image(
  'projects/ee-mudeledimeji/assets/postdoc/deforestation_mdg_paper/rasters/from_glc_landcover/FROM_GLC_yearImg_2018'
  ).clip(roi);
...
var esri_image = ee.Image(
  'projects/ee-mudeledimeji/assets/postdoc/deforestation_mdg_paper/rasters/esri_landcover/esri_mdg_2018'
  ).clip(roi);
...
Export.image.toDrive({
  ...
  description: "agreement_map_2018_30m", // Get the export name as a plain JavaScript string
